...
DLL_Export void DLL_FUNC SGP4_init(int *params, const tle_t *tle);
DLL_Export int  DLL_FUNC SGP4(const double tsince, const tle_t *tle, const double *params,
                                     double *pos, double *vel);

DLL_Export void DLL_FUNC SGP8_init(double *params, const tle_t *tle);
DLL_Export int  DLL_FUNC SGP8(const double tsince, const tle_t *tle, const double *params,
                                     double *pos, double *vel);
...
DLL_Export void DLL_FUNC SDP8_init(double *params, const tle_t *tle);
DLL_Export int  DLL_FUNC SDP8(const double tsince, const tle_t *tle, const double *params,
                                     double *pos, double *vel);
...
#ifdef _WIN32
DLL_Export int DLL_FUNC SXPX_init(double *params, const tle_t *tle, const int sxpx_num);
DLL_Export int DLL_FUNC SXPX(const double tsince, const tle_t *tle, const double *params,
